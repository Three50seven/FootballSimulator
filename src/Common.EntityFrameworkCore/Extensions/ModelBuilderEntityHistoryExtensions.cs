...
namespace Common.EntityFrameworkCore
{
    public static class ModelBuilderEntityHistoryExtensions
    {
        ...
        {
            Guard.IsNotNull(modelBuilder, "modelBuilder");
            return modelBuilder.ApplyConfiguration(new EntityHistoryConfiguration<TUser>()).ApplyConfiguration(new EntityHistoryChangeConfiguration()).ApplyConfiguration(new EntityTypeConfiguration<TTypeEnum>());
        }
    }
}
